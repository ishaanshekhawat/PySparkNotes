...
# Demo - Sliding window
#
# This is a demo of Sliding window 
...
# MSFT_2017.csv
# 
# In the output, the windows overlap
#
# Import Libraries
...
.builder\
.master("local")\
.appName("Operation - Sliding window")\
.getOrCreate()
...
.groupBy(F.window(F.col('Date'), "10 days", slideDuration = "5 days"), F.col("Name"))\
.agg({"High": "max"})
